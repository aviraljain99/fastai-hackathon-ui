...
class Viewer {
  ...
  // setControls() {
  //   this.viewerControls.forEach(control => {
  ...
  setCurrentState(direction) {
    // Make the currentPage hidden
    this.viewerArray[this.currentPage].style.display = "none";
...
const exampleCarousel = new Viewer(galleryContainer, galleryItems, galleryControls);
